package com.example.livro.secure;
...
/**
 * Representa o MP Auth token
 */

public class MPJWTToken {

    private String iss; // issuer
    private String aud; // audiencia
    private String jti; // identificador unico
    private Long exp; // tempo de expiracao
    private Long iat; // data e hora de criacao do token 
    private String sub; // subject
    private String upn; // Nome do usuario (principal)
    private String preferredUsername;  // Nome do usuario (principal)
